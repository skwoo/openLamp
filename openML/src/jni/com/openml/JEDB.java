...
public class JEDB
{
    ...
    public static final int SQL_STMT_ADMIN       = 12;
    public static final int SQL_STMT_DROP        = 13;
    public static final int SQL_STMT_COMMIT      = 14;
    public static final int SQL_STMT_ROLLBACK    = 15;
    public static final int SQL_STMT_SET         = 16;
